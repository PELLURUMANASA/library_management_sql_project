...
values('RS119','IS130',current_date);
...
CALL add_return_records('RS139','IS140');
...
select br.branch_id,
	   br.manager_id,
	   count(iss.issued_id) as no_books,
	   count(rs.return_id) as no_books_return,
...
values
('IS141','C102','Animal Farm','14-08-2025','978-0-330-25864-8','E104'),
('IS142','C108','Jane Eyre','21-08-2025','978-0-141-44171-6','E106');
...
-- all the code
		...
		IF v_status = 'yes' THEN
			...
			RAISE NOTICE 'Book records added succesfully fro book isbn : %', p_issued_book_isbn;
...
select * from issued_status;
CALL issue_book('IS144','C106','978-0-553-29698-2','E105');
